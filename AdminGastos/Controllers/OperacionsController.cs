...
namespace AdminGastos.Controllers
{
    public class OperacionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdOperacion,importe,fecha,producto")] Operacion operacion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdOperacion,importe")] Operacion operacion)
        {
